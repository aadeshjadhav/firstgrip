<?php
	...
	$_SESSION['sessionname2'] = $_POST['userid'];

	$query = " SELECT name from foundationdata ";
...
<body>
	...
	<div class="container-fluid">
		<div>
			<div class="col-sm-6" style="padding-top: 2%; padding-left: 4%;"><h1 class="fontsize5">Amount Portal</h1></div>
		</div>
	</div>

	<div style="padding-left: 4%;"><p style="border:2px solid orange; width: 15%; height: 0px;" ></p></div>

	<form action="transferamount.php" method="POST">
								...
								<div style="padding: 1px;">
									<div class="jumbotron text-center" style="background-color: #e6ffff;">
										<div class="form-group">
              								<label style="font-size: 20px;">Enter Amount to Send : </label>
